...
water_level = loadmat('./dataset/DailyWaterLevel_MichiganHuron.mat')['lvl_mat']['water_level'][0][0]
...
for i in range(len(var_list)):
    var = var_list[i]
    at_var = loadmat('./dataset/data_glmh_1981to2023_cfsr_t2_wspd_precip.mat')['dd'][var][0][0][0]
    year_data_set = []
