...
def generate_prediction_data(date_test, date_original, dataset_test, dataset_original, parameter, wl_sup, wl_mh):
...
def test_analysis(date, dataset, dataset_original, max_dic, min_dic, results, targets, parameter, scaler):
    ...
    # Define axis limits
    ax1.set_ylim(173.2, 175.5)
    ax2.set_ylim(173.2*3.281, 175.5*3.281)
