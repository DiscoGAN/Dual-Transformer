...
# Configuration class for Transformer model training and evaluation
class config():
    def __init__(self):
        self.cycle_num_before = 12  # Number of historical time steps used as input
        self.cycle_num_later = 5  # Number of future time steps used as input
        ...
        self.train_pro = 1  # Training dataset proportion
        ...
        self.total_year = 100  # Total available years in the dataset
...
# Initialize models
transformer_base = Transformer_half_base(wl_p)
transformer_modify = Transformer_half_modify(wl_p)
