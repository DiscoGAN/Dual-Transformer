...
class auto_weighted(torch.nn.Module):
    def __init__(self, parameter):
        ...
        self.cycle_num_before = parameter.cycle_num_before  # Past cycle count
        self.cycle_num_later = parameter.cycle_num_later  # Future cycle count
    ...
    def forward(self, dataset):
        ...
        dataset_future = dataset[:, self.cycle_num_before:self.cycle_num_before + self.cycle_num_later, 1:]  # Extract future data (excluding Lake Erie water level)
