...
# Configuration class for Prophet parameters
class Transconfig():
    def __init__(self):
        ...
        self.output_size = 1  # Output dimension -- default
        self.cycle_num = 12  # Number of time steps in input sequence (historical) -- default
...
class Transformer_half_base(torch.nn.Module):
    def __init__(self, parameter):
        ...
        transconfig.cycle_num = parameter.cycle_num_before
        transconfig.output_size = parameter.output_size

    def forward(self, enc_inputs):
        enc_inputs = torch.FloatTensor(enc_inputs).reshape((-1, 12, 7))
